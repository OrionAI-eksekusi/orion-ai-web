        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '32px' }}>
          <div style={{ maxWidth: '600px' }}>
            ...
            <div style={{ background: '#0D1321', border: '1px solid #1F2D45', borderRadius: '14px', padding: '24px', marginBottom: '20px' }}>
              ...
              <div style={{ marginBottom: '16px' }}>
                <label style={{ fontSize: '12px', color: '#8899B4', fontWeight: 600, display: 'block', marginBottom: '8px' }}>🛍️ Daftar Produk & Harga</label>
                <textarea id="sop-products" rows={4} placeholder="Produk A: Rp 100.000" style={{ width: '100%', padding: '10px', background: '#111827', border: '1px solid #1F2D45', borderRadius: '8px', color: '#F0F4FF', fontSize: '13px', outline: 'none', fontFamily: 'inherit', resize: 'vertical', boxSizing: 'border-box' }} />
              </div>
              <div style={{ marginBottom: '16px' }}>
                <label style={{ fontSize: '12px', color: '#8899B4', fontWeight: 600, display: 'block', marginBottom: '8px' }}>❓ FAQ & Cara Order</label>
                <textarea id="sop-faq" rows={4} placeholder="Q: Cara order? A: Chat WA ini" style={{ width: '100%', padding: '10px', background: '#111827', border: '1px solid #1F2D45', borderRadius: '8px', color: '#F0F4FF', fontSize: '13px', outline: 'none', fontFamily: 'inherit', resize: 'vertical', boxSizing: 'border-box' }} />
              </div>
              <div style={{ marginBottom: '16px' }}>
                <label style={{ fontSize: '12px', color: '#8899B4', fontWeight: 600, display: 'block', marginBottom: '8px' }}>🎁 Promo & Diskon</label>
                <textarea id="sop-promo" rows={3} placeholder="Promo bulan ini: diskon 10%" style={{ width: '100%', padding: '10px', background: '#111827', border: '1px solid #1F2D45', borderRadius: '8px', color: '#F0F4FF', fontSize: '13px', outline: 'none', fontFamily: 'inherit', resize: 'vertical', boxSizing: 'border-box' }} />
              </div>
            </div>
            {/* Save */}
